...
const ViewBranchCustomerUsingApp = () => {
    ...
    useEffect(() => {
        ...
        dispatch(fetchBranchCustomerNewCustomersRequest());
    }, [dispatch]);
            ...
            <div className="mx-auto max-w-7xl space-y-4">
                <section className="overflow-hidden rounded-3xl bg-slate-950 text-white shadow-sm">
                    <div className="relative p-4 sm:p-6">
                        <div className="absolute right-0 top-0 h-28 w-28 rounded-bl-full bg-blue-500/20 sm:h-40 sm:w-40" />
                ...
                <section className="rounded-3xl border border-slate-200 bg-white p-3 shadow-sm sm:p-4">
                    ...
                    <input
                        ...
                        className="w-full rounded-2xl border border-slate-200 px-4 py-3 text-sm font-semibold outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
                    />
                </section>
