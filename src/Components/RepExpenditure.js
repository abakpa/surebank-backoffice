...
import { createRepExpenditureRequest } from '../redux/slices/expenditureSlice'

const RepExpenditure = () => {
    ...
    const handleSubmit = (e) =>{
        ...
        dispatch(createRepExpenditureRequest(data))
    }
